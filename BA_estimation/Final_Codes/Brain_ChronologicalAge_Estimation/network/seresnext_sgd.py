...
from keras.layers import Input, Permute, Reshape, multiply
...
if __name__ == '__main__':
    model = SEResNext((32, 32, 3), depth=29, cardinality=8, width=16)
    plot_model(model, to_file='SE_Resnext_model.png', show_shapes=True)
    model.summary()