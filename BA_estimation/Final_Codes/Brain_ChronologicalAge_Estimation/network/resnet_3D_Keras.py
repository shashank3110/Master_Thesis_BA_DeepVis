...
def _residual_block3d(block_function, filters, kernel_regularizer, repetitions,
    ...
    def f(input):
        for i in range(repetitions):
            ...
            print('The output of res block is')
            print(input)
        return input
...
class Resnet3DBuilder(object):
    ...
    @staticmethod
    def build(input_shape, block_fn, repetitions, reg_factor):
        ...
        #pool1 = MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2),
        #                     padding="same")(conv1)
        print('tensor before entering res block')
        print(conv1)
        # repeat blocks
        block = conv1
        filters = 64
    ...
    def build_resnet_18(input_shape, reg_factor=1e-4):
        """Build resnet 18."""
        return Resnet3DBuilder.build(input_shape, basic_block,
    ...
    def build_resnet_50(input_shape, reg_factor=1e-4):
        """Build resnet 50."""
        return Resnet3DBuilder.build(input_shape, bottleneck,
                                     [3, 4, 6, 3], reg_factor=reg_factor)
...
if __name__ == '__main__':
    model = Resnet3DBuilder.build_resnet_18(input_shape = [121, 145, 121, 1], reg_factor=1e-4)
    plot_model(model, to_file='/home/d1308/no_backup/d1308/3T_Brain_age_regression/network/Resnet_3D.png', show_shapes=True)
    model.summary()