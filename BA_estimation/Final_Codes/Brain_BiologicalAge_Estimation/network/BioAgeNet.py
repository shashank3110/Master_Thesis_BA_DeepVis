...
def createModel(patchSize, num_slice_per_group, weight_decay, depth, cardinality, width):
    ...
    x_1=concatenate([output_list[0], input_gender, intput_height, input_weight])
    x_2=concatenate([output_list[1], input_gender, intput_height, input_weight])
    x_3=concatenate([output_list[2], input_gender, intput_height, input_weight])
...
#                  kernel_initializer='he_normal', activation='softmax')(x)
    ...
    cnn = Model([input_tensor, input_gender, intput_height, input_weight], output, name=sModelName)
    return cnn, sModelName

if __name__ == '__main__':
    model,_ = createModel([224,224], 3, weight_decay=5e-4, depth=[2, 2, 2], cardinality = 16, width = 8)
